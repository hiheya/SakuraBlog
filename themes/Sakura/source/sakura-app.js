...
$(document).ready(function () {
  function changeBG(tagid, imgFileName) {
    $('.skin-menu ' + tagid).click(function () {
      const imgURL = './img/background/' + imgFileName;
      ...
      $('#banner_wave_2').addClass('banner_wave_hide_fit_skin');
      closeSkinMenu();
      setCookie('bgImgSetting', imgURL, 30);
    });
  }
  

  function changeBGnoTrans (tagid, imgFileName) {
    $('.skin-menu ' + tagid).click(function () {
      const imgURL = './img/background/' + imgFileName;
  ...
  // changeBG('#totem-bg', 'https://pic.ziyuan.wang/2023/07/29/a73920a763f12.png')
  // changeBG('#sakura-bg', 'https://pic.ziyuan.wang/2023/07/29/1f7918e92e90d.png')
  // changeBG('#gribs-bg', 'https://pic.ziyuan.wang/2023/07/29/48c89ff7812b5.png')
  // changeBG('#pixiv-bg', 'https://pic.ziyuan.wang/2023/07/29/85fc93b5fdd4c.png')
  // changeBG('#KAdots-bg', 'https://pic.ziyuan.wang/2023/07/29/6baf74777b44a.png')
  // changeBG('#totem-bg', 'https://pic.ziyuan.wang/2023/07/29/a73920a763f12.png')
  changeBG('#totem-bg', 'img1.png')
  changeBG('#sakura-bg', 'img2.png')
  changeBG('#gribs-bg', 'img3.png')
  changeBG('#pixiv-bg', 'img4.png')
  changeBG('#KAdots-bg', 'img5.png')
  changeBG('#totem-bg', 'img6.png')
  // changeBGnoTrans('#bing-bg', 'https://api.shino.cc/bing/')
  changeBGnoTrans('#bing-bg', 'img5.png')
      ...
      $('body').on('click', '#pagination a', function () {
        ...
        $.ajax({
          ...
          success: function (data) {
            ...
            $('#pagination a').removeClass('loading').text('更多文章')
            lazyload()
